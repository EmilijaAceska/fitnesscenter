...
switch($table_name){
  ...
  case "instructors":
    ...
    foreach($result as $row){
          ...
          "category_title"=>$row["category_title"],"category_img"=>$row["category_img"]);    
        }
  break;
  case "products":
  ...
  case "members":
    ...
    // var_dump($result);
    foreach($result as $row){
          $data["records"][]=array("members_id"=>$row["members_id"],"f_name"=>$row["f_name"],"l_name"=>$row["l_name"],
  ...
  case "schedules":
    ...
    foreach($result as $row){
          ...
          "f_name"=>$row["f_name"],"l_name"=>$row["l_name"],"email"=>$row["email"],"phone_number"=>$row["phone_number"],"product_title"=>$row["product_title"],
  ...
  case "payment":
    ...
    foreach($result as $row){
          ...
          "payment_status"=>$row["payment_status"],"payment_date"=>$row["payment_date"],"f_name"=>$row["f_name"],
          "l_name"=>$row["l_name"],"email"=>$row["email"],"phone_number"=>$row["phone_number"],"product_title"=>$row["product_title"],
          "product_description"=>$row["product_description"],"product_price"=>$row["product_price"],"category_title"=>$row["category_title"]);    
        }
  break;
  case "notifications":
    ...
    foreach($result as $row){
          ...
          "notification_content"=>$row["notification_content"],"members_id"=>$row["members_id"],"f_name"=>$row["f_name"],
          "l_name"=>$row["l_name"],"email"=>$row["email"],"phone_number"=>$row["phone_number"]);    
        }
  break;
  case "orders":
        ...
        // var_dump($result);
        foreach($result as $row){
                $data["records"][]=array("order_id"=>$row["order_id"],"first_name"=>$row["first_name"],"last_name"=>$row["last_name"],"order_method"=>$row["order_method"],
              "card_number"=>$row["card_number"],"product_id"=>$row["product_id"],"date_time"=>$row["date_time"],"product_title"=>$row["product_title"],
