...
class ModelModeli extends DB
{
    ...
    private $columns_name="model_name,color,price,km,marka_id";
    ...
    public function insertModeliWithSetter(){
        $columns_value="'$this->model_name','$this->color',$this->price,$this->km,$this->marka_id";
    ...
    //     parent::insertRow($this->table_name,$this->columns_name,$columns_value);
    // }
    // public function deleteodeli($pk_value){
